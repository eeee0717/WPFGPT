...
public class ChatGpt
{
    ...
    public async Task Chat(ObservableCollection<ChatMessage> chatObservableCollection,string? prompt, int systemType)
    {
        ...
        var chatRequest = new ChatRequest(chatPrompts, maxTokens: this.MaxToken, model: Model.GPT3_5_Turbo);
        var response = "";
